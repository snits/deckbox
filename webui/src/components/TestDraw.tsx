...
export function TestDraw({ deck, editRevision }: TestDrawProps) {
  ...
  return (
    <>
      ...
      <div className="testdraw-bar">
        ...
        />
        <button type="button" className="testdraw-btn" onClick={handlePeek}>
          ◉ Peek
        </button>
        <button type="button" className="testdraw-btn" onClick={handleShuffle}>
          ⇄ Shuffle
        </button>
      ...
      {pileEmpty && <div className="testdraw-hint">pile empty — reset to draw again</div>}
